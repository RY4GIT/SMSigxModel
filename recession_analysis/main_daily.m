...
data = readtable("C:\Program Files (x86)\HBV-light\Data\Coweeta\Data\ptq.txt");
...
[MRC_num_segments,Segment_slopes]  = sig_MRC_SlopeChanges(Q, t,  'recession_length', 6, 'plot_results', true, 'seg_test', 2);
