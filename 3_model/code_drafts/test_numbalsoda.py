...
# ODE for Zone 1
@cfunc(lsoda_sig)
# storage_threshold_primary_m, storage_max_m, coeff_primary, coeff_secondary, PET, infilt, wltsmc
...
funcptr = conceptual_reservoir_flux_calc.address
...
t0 = 0
y0 = np.array([y])
data = np.array([storage_threshold_primary_m, storage_max_m, coeff_primary, coeff_secondary, PET, infilt, wltsmc])
