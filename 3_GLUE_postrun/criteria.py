...
class Criteria(object):
    ...
    def get_behavioral_criteria(self):
        ...
        GLUE_criteria_path = os.path.join(self.config['PATHS']['GLUE_criteria_config'], f"GLUE_criteria_{self.id}.json")
    ...
    def get_full_behavioral_criteria(self):
        ...
        for (key, criterion) in self.criteria.items():
            ...
            if criterion["metric"] == 'season_transition':
                ...
                transitions = ["dry2wet_start", "dry2wet_end", "wet2dry_start", "wet2dry_end"]
