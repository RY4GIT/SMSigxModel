...
class MyGLUE(object):
    def __init__(self, out_path='./', config_path_CFE='', nrun=1, eval_criteria=dict()):
        ...
        self.eval_criteria =  {
            ...
            2: {'variable_to_analyze': 'Soil Moisture Content', 'metric': 'season_transition'}
            }
    ...
    def simulation(self, sampled_params):
        ...
        target_config_CFE = os.path.join(r"..\2_data_input\Mahurangi\parameters", f"config_cfe_{nth_run}.json")
    ...
    def to_csv(self, df_param_to_calibrate=None):
        ...
        df_param_to_calibrate.to_csv(os.path.join(self.out_path, 'parameter_bounds_used.csv'), sep=',', header=True, index=True, encoding='utf-8', na_rep='nan')
